...
**🔀 Типы активности:**
- **Случайные переводы** - Разные суммы между кошельками (0.001-0.011 ETH)
...
**⏰ Временные интервалы:**
- Случайные задержки от 30 секунд до 5 минут
...
- **Случайные переводы** между кошельками (разные суммы)
- **Деплой новых контрактов** в случайное время
- **Взаимодействия с контрактами** (setGreeting, ping, batchPing)
- **Мульти-переводы** одним кошельком нескольким получателям  
- **Проверка балансов** и вызовы view функций
- Активность происходит каждые 30 секунд - 5 минут
